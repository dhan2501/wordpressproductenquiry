    ...
    <div class="card">
        ...
        <div class="card-body">
            <h4 class="card-title h6" style="height: 85px;"><a href="<?php the_permalink(); ?>" style="color: #000;text-decoration: none;font-size: 15px;"><?php the_title(); ?></a></h4>
            ...
            <a href="<?php the_permalink(); ?>" class="btn btn-info" style="width: 100%;">Read More</a>
        </div>    
    </div>